...
$bodySoCo = @{
    "label"        = "SoCo Gateway"
    "list_type"    = "ALLOW"
    "ip_addresses" = "4.59.172.35", "24.143.216.228", "66.44.198.240", "212.176.73.78"
} | ConvertTo-Json
...
$bodyGithubActions = @{
    "label"        = "GitHub"
    "list_type"    = "ALLOW"
    "ip_addresses" = "20.102.221.48/28","13.83.160.32/28"
} | ConvertTo-Json
...
# Github
$response.ip_access_lists | ForEach-Object -Process { if ($_.label -eq "Github") { Write-Host "Deleting IP Access List " $_.label; Invoke-WebRequest -Uri ($DatabricksWorkspace + "api/2.0/ip-access-lists/" + $_.list_id) -Method Delete -Headers $header } }
Invoke-WebRequest -Uri ($DatabricksWorkspace + "api/2.0/ip-access-lists")  -Method Post -Headers $header -Body $bodyGithubActions
